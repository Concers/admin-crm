...
## 14. Finans Derinliği (2026-06-19)
- [x] Bütçe vs gerçekleşen — `/raporlar/butce` + hedef CRUD
- [x] Nakit tahmin — `/raporlar/nakit-akis` (3–6–9–12 ay projeksiyon)
- [x] Çek / senet portföyü — `/finans/cek-senet`
- [x] Maliyet revizyon geçmişi — `/raporlar/maliyet-gecmisi` (alım/gider tetiklemeli)
- [x] Kur farkı raporu — `/raporlar/kur-farki` (TCMB güncel kur karşılaştırması)
